    ...
    keyboardCases: [
      {
        ...
        fire: (context) => {
          for (let i = 0; i < context.game.biome.currentLevel.levelDoors.length; i++) {
            ...
            if (!context.game.player.checkIfPlayerCollideWithADoor(context.game.player, door)) return;
            ...
            door.playOnce();
            context.game.currentState = 'ONLEVELTRANSITION';
